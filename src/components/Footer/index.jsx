...
import { FooterWrapper, ContainerFooter, ContentFooter, DescFooter, TitleFooter, ContentEmail, EmailWrapper, EmailLine, EmailBtn, PositionCopy, Copyright } from './styled';
      ...
      <ContainerFooter>
        ...
        <ContentFooter>
          ...
          <div>
            ...
            <ContentEmail>
              <EmailWrapper />
              <EmailLine name="contactEmail" type="email" placeholder="Your E-mail" />
